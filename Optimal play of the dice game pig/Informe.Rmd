...
hasta que $\triangle<e$  
donde $0< e <1$ indica la aproximación a los valores óptimos
...
Definamos puesa las reglas basicas de modo similar al "play of the dice game pig"
...
El ejemplo esta dado para que sea una versión mas simple y nos permita guiarnos a la solución buscada. Definiendo i como puntaje del jugador, j como puntaje del oponente y k como puntaje de turno, en el caso que i+k=2 $P_{i,j,k}=1$ en el resto de casos donde $0\leqi,j<2$ y $k<2-i$, la probabilidad de ganar es:
